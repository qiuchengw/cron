...
// --------------------------------------------------------------------------
inline bool wsGetStringType(LCID lc, uint32_t dwT, PCSTR pS, int nSize,
                            uint16_t* pWd) {
    return false != GetStringTypeExA(lc, dwT, pS, nSize, pWd);
}
inline bool wsGetStringType(LCID lc, uint32_t dwT, PCWSTR pS, int nSize,
                            uint16_t* pWd) {
...
// -----------------------------------------------------------------------------
#if defined (SS_WIN32) && !defined(SS_ANSI)
inline uint32_t ssfmtmsg(uint32_t dwFlags, LPCVOID pSrc, uint32_t dwMsgId,
                         uint32_t dwLangId, PSTR pBuf, uint32_t nSize,
                         va_list* vlArgs) {
    return FormatMessageA(dwFlags, pSrc, dwMsgId, dwLangId,
                          pBuf, nSize,vlArgs);
}
inline uint32_t ssfmtmsg(uint32_t dwFlags, LPCVOID pSrc, uint32_t dwMsgId,
                         uint32_t dwLangId, PWSTR pBuf, uint32_t nSize,
                         va_list* vlArgs) {
...
inline CStdStringA WUSysMessageA(uint32_t dwError, uint32_t dwLangId=SS_DEFLANGID) {
    CHAR szBuf[512];
...
inline CStdStringW WUSysMessageW(uint32_t dwError, uint32_t dwLangId=SS_DEFLANGID) {
    WCHAR szBuf[512];
